...
1. **Import unitypackage**  
   [PL_PPC_UiGen.unitypackage](./Documentation/PL_PPC_UiGen.unitypackage)
...
4. **UI Object Names**  
   ...
   ![UiToolKitEditor](./Documentation/UiToolKitEditor.png)

5. **Close Button Requirement**  
   If you want a close button, it **must** be named `"CloseMenu"`.  
   ![CloseButton](./Documentation/CloseButton.png)
...
7. **Generate UI Code**  
   ...
   ![GenerateUiCodeButton](./Documentation/GenerateUiCodeButton.png)  
   ![UiToolKitGenerator](./Documentation/UiToolKitGenerator.png)
...
8. **Select the Export Path**  
   ...
   ![Vs Folder](./Documentation/VS_Folder.png)
...
11. **Accept or Modify Suggested Fixes**  
   ...
   ![UiToolKitGeneratorApplyFixes](./Documentation/UiToolKitGeneratorApplyFixes.png)
...
13. **Add DLL Reference**  
   Add `!0PPC-UiGen-BaseType.dll` as a reference in your plugin and place it in the `Plugins` or `Managed` folder.  
    [!0PPC-UiGen-BaseType.dll](./Documentation/%210PPC-UiGen-BaseType.dll)
...
## 📌 Currently Supported UI Toolkit Elements
